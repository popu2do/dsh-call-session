...
| **ADR-0003** | Workspace-Scoped Isolation by Default with Cross-Workspace Opt-in | **Accepted** | 2026-09-03 | `lib/board-store.mjs`, `lib/session-directory.mjs`, `lib/session-query.mjs` | [0003-workspace-scoped-isolation-by-default.md](./0003-workspace-scoped-isolation-by-default.md) |
...
| **ADR-0005** | English Metadata and Normalized Two-State Status Protocol | **Accepted** | 2026-09-03 | `lib/session-directory.mjs`, `lib/session-query.mjs`, `index.mjs` | [0005-english-metadata-and-two-state-status.md](./0005-english-metadata-and-two-state-status.md) |
