...
| **ADR-0014** | Canvas Gutter Routing, Lineage Focus, and Scoped Theme Parity | **Accepted** | 2026-09-10 | `lib/client.js`, `docs/prd-collaboration-canvas.md` | [0014-canvas-gutter-routing-and-scoped-theme-parity.md](./0014-canvas-gutter-routing-and-scoped-theme-parity.md) |
