...
| **ADR-0013** | Human Canvas Global Transparency vs Agent Workspace Isolation | **Accepted** *(Amended: viewport fit and clamped session locating)* | 2026-09-10 *(Updated: 2026-09-20)* | `lib/client.js`, `lib/call-telemetry.mjs`, `lib/web-telemetry-route.mjs` | [0013-human-canvas-global-transparency-vs-agent-workspace-isolation.md](./0013-human-canvas-global-transparency-vs-agent-workspace-isolation.md) |
